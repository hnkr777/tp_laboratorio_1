...
int main(int args, char** argsv){
    ...
    do{
        ...
        switch(option){
            ...
            case 7:
            	showOperation(operand1, operand2, flag|FLAG_MENU_7);
                break;
...
void showOperation(int operand1, int operand2, char flag){
	...
	if(flag&FLAG_OPERAND_1 && flag&FLAG_OPERAND_2){ // se utilizan condicionales de una linea (sin llaves) para un código más legible y compacto
		if(flag&FLAG_MENU_8)
